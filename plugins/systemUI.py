...
def systemUI(src, dist, FileName):
	...
	for i in range(1):
		...
		FileOut = open(OutFileName, 'w')
		NewFileContent = str(FileContent).replace('systemUI', "-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Oxygen-Sans,Ubuntu,Cantarell,'Helvetica Neue',sans-serif")
